...
class CodeService:
    ...
    def create(self, email: str) -> str:
        code_entity = CodeEntity(code=str(random.randrange(100000, 999999)), email=email)
    ...
    def send(self, email: str):
        ...
        return self.smtp_service.send_email(email, "Verification Code", f"Your code is {code}")
